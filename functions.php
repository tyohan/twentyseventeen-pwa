...
function twentyseventeen_scripts() {
	...
	// Theme stylesheet.
	//wp_enqueue_style( 'twentyseventeen-style', get_stylesheet_uri() ); //disable because we have inline the css file
...
require get_parent_theme_file_path( '/inc/icon-functions.php' );
 ...
 function lazyloadImages($html) {
  ...
  function initLazyLoad(){
	...
	wp_enqueue_script( 'lazyload', get_theme_file_uri( '/assets/js/lazyload.js' ));
  }
